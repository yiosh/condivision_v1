<?php 
	...
	if(isset($_GET['data_da']) && check($_GET['data_da']) != "" && check($_GET['data_a']) != "") { 
	 ...
	 $data_a_t = date('d/m/Y',time()+91500000); 
	}
	...
	if($_SESSION['usertype'] == 2 ) $tipologia_main = "WHERE id != 1 ";
	$tipologia_main .= ricerca_semplice('titolo_ricorrenza','titolo_ricorrenza');	
	$tipologia_main .= ")";
	}
	...
	$module_menu = '';
	$menu = array('Appuntamenti'=>'../mod_appuntamenti/?action=23&meeting_location=0','Eventi'=>'../mod_eventi/?','Lista Eventi'=>'../mod_eventi/?action=17',);
