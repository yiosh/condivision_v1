...
if(@$id == 1) {
 echo '<input type="hidden" name="reload" value="../mod_anagrafica/?j='.base64_encode($lead_id).'&associa_evento=" />';
} else {
 echo '<input type="hidden" name="reload" value="../mod_eventi/?action=17&last=" />';
}
?>
</form>
