<?php 
	...
	$tab_div_labels = array('id'=>"Profilo",'forma_giuridica'=>"Dati Fiscali",'telefono'=>"Contatti");
	} else {
	$tab_div_labels = array('id'=>"Profilo",'cognome'=>"Dati Anagrafici",'tipo_documento'=>"Dati Documento",'forma_giuridica'=>"Dati Fiscali",'tipologia_attivita'=>"Altre Informazioni",'telefono'=>"Contatti",'note'=>"Note");
	}
	...
	$select = array('scheda_apertura','emesso_da','sesso','concessione_fido','marchio','tipo_profilo_scheda','stato_nascita','stato_punto','stato_sede','regione_residenza','stato_residenza','account_id',"provincia","tipo_documento","punto_vendita","regione_sede","regione_punto","status_anagrafica","proprietario","status","regione","nazione");
	$select_text = array('citta','provincia','provincia_nascita','comune_punto','comune_sede','comune_residenza','provincia_residenza',"provincia_sede","provincia_punto");
	$disabled = array("visite");
	$hidden = array('status_anagrafica','data_creazione','data_aggiornamento','account_id','tipo_utente','operatore','ip','proprietario',"relation",'tipologia_attivita','forma_giuridica');
