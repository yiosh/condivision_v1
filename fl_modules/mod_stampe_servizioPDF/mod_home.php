	...
	<table class="dati" summary="Dati" style=" width: 100%;">
		...
		while ($riga = mysql_fetch_array($risultato)) 
		{
		  ...
		  $colorMenu = ($menuPortate['id'] > 1) ? $coloreEvento : 'gray';
			...
			if($tavoli['id'] > 1) echo "<a data-fancybox-type=\"iframe\" class=\"fancybox_view \" href=\"mod_cavalieri.php?evento_id=".$riga['id']."\" title=\"Stampa Cavalieri\" style=\"color:   $colorScheda\"><i class=\"fa fa-bookmark\" aria-hidden=\"true\"></i>  CAVALIERI</i></a>";
