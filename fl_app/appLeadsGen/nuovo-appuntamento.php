    ...
    <div class="list-block inputs-list">
     ...
     <li>
          <div class="item-content">
            ...
            <div class="item-inner"> 
              <div class="item-title label">Desidera prenotare un visita presso la struttura?</div>
              <div class="item-input">
                <label class="label-switch">
                  <input type="checkbox" value="1" name="appuntamento_tap" id="appuntamento_tap" />
...
<div id="appuntamento_box" >
       ...
       <li>
          <div class="item-content">
            ...
            <div class="item-inner"> 
              <div class="item-title floating-label">Data appuntamento </div>
              <div class="item-input">
                <input type="date" placeholder="" value="<?php echo date('Y-m-d'); ?>" name="meeting_date"  />
              </div>
            </div>
          </div>
        </li>
          ...
          <div class="item-content">
            ...
            <div class="item-inner"> 
              <div class="item-title floating-label">Orario</div>
              <div class="item-input">
                <input type="time" placeholder="" name="meeting_time"  value="<?php echo date('H'); ?>:00"  />
              </div>
            </div>
          </div>
        </li>
  ...
  <li>
          <div class="item-content">
            <div class="item-media"></div>
            <div class="item-inner"> 
              <div class="item-title floating-label">Tipo appuntamento</div>
              <div class="item-input">
               <select class="" name="tipo_appuntamento" id="tipo_appuntamento">
              <option value="122">Prima visita</option></select>        
