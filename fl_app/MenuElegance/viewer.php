...
echo '<span><h2>'.converti_txt($riga_res['nome']).'</h2>'.$aggiungi.'</span>';
...
echo '<li class="ricetta '.$class.'"><img src="'.$img.'" title="'.converti_txt($riga_res['nome']).': '.strip_tags(converti_txt($riga_res['note'])).' '.$prezzo.'" />
'.$aggiungi.'</li>';
