...
<?php
	foreach($finger_food as $key => $value) { if($key > 1) echo '<input   type="checkbox" id="'.$value.'" name="selezione[]" value="'.$value.'"><label style="width: 100%;" for="'.$value.'">'.$value.'</label><br>'; }
?>

<input  type="text"  name="altro" placeholder="Altro">
